...
import { selectAllProducts, fetchAllProductsAsync, fetchProductsByFiltersAsync, selectTotalItems, selectTotalBrands, selectCategories, fetchCategoriesAsync, fetchBrandsAsync } from "../ProductSlice";
...
import {
  ...
  MinusIcon,
  PlusIcon,
  Squares2X2Icon,ChevronLeftIcon, ChevronRightIcon ,StarIcon
...
function ProductGrid({products}) {
  return ( <div className="bg-slate-100 py-6 rounded-md ">
