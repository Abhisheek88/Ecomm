    ...
    <div className=" mt-9 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8  rounded-md ">
      <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5 ">
        <div className="lg:col-span-3">
          <form className="bg-stone-200 p-4  rounded-md">
            <div className="space-y-12 ">
              ...
              <div className="border-b border-gray-900/10 pb-12">
                ...
                <ul role="list" className=" ">
                  {addresses.map((address) => (
                    ...
                    <li
                      key={address.email}
                      className={`flex justify-between gap-x-6 p-5 border ${
                        selectedAddress === address.email
                          ? "border-indigo-600 ring-2 ring-black"
                          : "border-transparent"
                      } rounded-md`}
                    >
              ...
              checked={selectedAddress === address.email}
            />
        ...
        <div className="lg:col-span-2">
          <div className=" bg-stone-200 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8    rounded-md ">
