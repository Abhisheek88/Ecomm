...
const products = [
  ...
  },
  {
    ...
    imageAlt: "Front of men's Comfort Hoodie in grey.",
    price: "$60",
    color: "Grey",
  },
  {
    ...
    imageAlt: "Men's Slim Fit Jeans in blue denim.",
    price: "$75",
    color: "Blue Denim",
  },
  {
    ...
    href: "#",
    imageSrc: "https://extrabutterny.in/cdn/shop/files/DX1487-687-1.jpg?v=1731761746",
  ...
  },
  {
    ...
    imageAlt: "Pair of Running Sneakers in white and grey.",
    price: "$90",
    color: "White/Grey",
  },
  ...
  return (
    <div>
      ...
      <div>
        ...
        <div className="bg-slate-600 py-6 rounded-md ">
              ...
              {products.map((product) => (
                <div key={product.id} className=" group relative">
                  <img
                    ...
                    className="aspect-square w-full rounded-md bg-teal-500  object-cover group-hover:opacity-75 lg:aspect-auto lg:h-80"
                  />
